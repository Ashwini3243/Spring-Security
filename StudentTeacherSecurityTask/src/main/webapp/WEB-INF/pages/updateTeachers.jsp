...
<c:url value="/updateTeacherdata" var="formUrl1"/>
<form:form modelAttribute="update" action="${formUrl1}" method="post">

    Teach_Id: <form:input path="id" readonly="true"/><br><br>
...
<a href="../dispTeachersList"><input type="button" value=" back " style="color: blue" ></a>
